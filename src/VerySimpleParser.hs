...
module VerySimpleParser where

import Data.Char
import Control.Applicative

{--
 I took this parser, that has no 3rd party dependencies from https://github.com/tsoding/haskell-json/commit/bafd97d96b792edd3e170525a7944b9f01de7e34
--}
